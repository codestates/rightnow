...
const Join = () => {
    ...
    const requestAuth = (): void => {
        if (userInfo.password !== userInfo.rePassword) {
            ...
            axios
                .post("https://elb-test-852958890.ap-northeast-2.elb.amazonaws.com/user/signupEmailAuth/", {
    ...
    const requestSignUp = (): void => {
        ...
        if (userInfo.auth !== authNumber) {
            ...
            axios
                .post("https://elb-test-852958890.ap-northeast-2.elb.amazonaws.com/user/signup/", {
                    email: userInfo.email,
                    name: userInfo.name,
