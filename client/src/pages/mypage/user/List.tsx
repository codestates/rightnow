...
const List = () => {
  ...
  return (
    <>
      <div className="text-lg font-semibold pl-1">전체유저 목록</div>
      <div className=" w-160 text-sub mt-2">
        ...
        {allUserList.map((obj, idx) => {
          ...
          return (
            <div
              className={`flex items-center w-full text-xs relative py-2 text-center ${idx !== allUserList.length-1 && 'border-b-1'}`}
              key={email}
            >
              <div
